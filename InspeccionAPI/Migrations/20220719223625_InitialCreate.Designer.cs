...
namespace InspeccionAPI.Migrations
{
    ...
    [Migration("20220719223625_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InspeccionAPI.Inspection", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InspeccionAPI.InspectionType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InspeccionAPI.Status", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InspeccionAPI.Inspection", b =>
                {
                    b.HasOne("InspeccionAPI.InspectionType", "InspectionType")
                        .WithMany()
